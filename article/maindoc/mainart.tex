...
leave for another firm during a job transition. ADD SUMMARY AFTER FINISHED
...
results are based on evaluation of each model on the test set.  Moreoever, each model 
...
determine one that has the best performance from a ROC curve perspective. DISCUSS SEARCH 
MORE.  The highest performing such model is 


The root node of this tree is associated with the 
...
\begin{figure}[thb]
    ...
    %\includegraphics[trim={3cm 3cm 3cm 3cm}, clip,width=0.9\linewidth]{avgsal.eps}
	\caption{ROC full Curves using ... }
	\label{fig:orgroc}
\end{figure}

\section{Conclusions and Extensions}

DESCRIBE HOW ROC CURVES ARE FORME VIA THRESHOLDING 
